...
INSERT INTO public.properties VALUES (1, 1.008, -259.1, -252.9, 0);
INSERT INTO public.properties VALUES (2, 4.0026, -272.2, -269, 0);
INSERT INTO public.properties VALUES (6, 12.011, 3550, 4027, 0);
INSERT INTO public.properties VALUES (7, 14.007, -210.1, -195.8, 0);
INSERT INTO public.properties VALUES (8, 15.999, -218, -183, 0);
...
INSERT INTO public.properties VALUES (9, 18.998, -220, -188.1, 0);
INSERT INTO public.properties VALUES (10, 20.18, -248.6, -246.1, 0);
...
INSERT INTO public.types VALUES (0, 'nonmetal');
...
--
-- Name: elements u_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements u_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT u_symbol UNIQUE (symbol);


--
-- Name: properties fk_atomic_num; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_atomic_num FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
